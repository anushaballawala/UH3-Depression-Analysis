...
keep_bl_idx = [1:8,10:11,13:16,19:28,30:51,53:59,62:70];
...
metadata.preprocessing.GoodChannelsIdx = metadata.preprocessing.GoodChannelsIdx(keep_stim_idx);
metadata.preprocessing.GoodChannelLabels = metadata.preprocessing.GoodChannelLabels(keep_stim_idx);
metadata.preprocessing.ChannelTbl = metadata.preprocessing.ChannelTbl(keep_stim_idx,:);
...
filename = sprintf('/Users/anushaallawala/Data/DBSTRD/%s_autocorrbl_data_for_PSD_stats.mat',PatientID) ; 
