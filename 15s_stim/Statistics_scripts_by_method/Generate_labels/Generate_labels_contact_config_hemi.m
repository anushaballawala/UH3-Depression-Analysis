...
for dbs_idx = 1:numel(DBS)
        ...
        dbs_matches =  contains(tbl.DBS_target(i), DBS{dbs_idx});             
...
save(sprintf('/Users/anushaallawala/Data/DBSTRD/Stats_data/labels_for_poststim_elecconfig_conds_%s_new_leftright',...
    PatientID), 'comps'); 
