...
cd '/users/aallawa1/data/TRD_Project/DBSTRD/DBSTRD006/Raw Data/15s_stim/'
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
clear 
stim_info = 'lSCC_03_f130'; 
...
disp('saving file') 
outputdir = sprintf('/gpfs/data/dborton/TRD_Project/DBSTRD/%s/EXP/15s_stim/Epochs',PatientID);
