%% Some factors that may affect results 
% ***** data not z-scored for lSCC 001 
% **** SHOULD I TRY FOR COHERENCE? or 

%% load averaged data saved for each condition 
    %list experiment info for each channel 
    PatientID = 'DBSTRD002'; DBS_target = 'SCC'; hemi = 'l'; stim_freq = 130; 
