...
caxis_limits = [0 0.5]; 
t_delta = generate_coherence_maps(matrix_coh_delta,...
    'delta',PatientID,experiment_name,stim_state,caxis_limits); 
t_theta = generate_coherence_maps(matrix_coh_theta,...
    'theta',PatientID,num_contact_configs,experiment_name,stim_state,caxis_limits); 
t_alpha = generate_coherence_maps(matrix_coh_alpha,...
    'alpha',PatientID,num_contact_configs,experiment_name,stim_state,caxis_limits); 
t_beta  = generate_coherence_maps(matrix_coh_beta,...
    'beta',PatientID,num_contact_configs,experiment_name,stim_state,caxis_limits); 
t_gamma = generate_coherence_maps(matrix_coh_gamma,...
