...
%function [] = plot_1overf_ON_OFF_PSD_ROI_indivch(PatientID, contact_config,...
                DBS_target, hemi, stim_freq,...
...
plot_time_series_channel(t, data , ...
...
filename = sprintf('E:/DBSTRD/%s/Experiments/15s_stim/Processed Data/%s/%s_time_series_ROI_elec%d.mat',PatientID,experiment_name, experiment_name,contact_config); 
save(fulldestination, 'good_ch_labels', 'metadata', 'timeseriesfile', ...
    'f', 'S', 'f_stim','S_stim','f_poststim','S_poststim',...
    'Serr','Serr_stim','Serr_poststim') 
%% save data with individual trial errors 


% filename = sprintf('E:/DBSTRD/%s/Experiments/15s_stim/Processed Data/%s/%s_time_series_ROI_indivtr_elec%d.mat',PatientID,experiment_name, experiment_name,contact_config); 
% save(fulldestination, 'good_ch_labels', 'metadata', 'timeseriesfile', ...
%     'f', 'S', 'f_stim','S_stim','f_poststim','S_poststim',...
%     'Serr','Serr_stim','Serr_poststim') 
