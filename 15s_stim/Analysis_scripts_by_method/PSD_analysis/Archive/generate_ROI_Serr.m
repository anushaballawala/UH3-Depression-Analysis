function [matrix_ROI] = generate_ROI_Serr(data,PatientID)
% set up ROIs 
...
switch PatientID
    case 'DBSTRD001'
        ...
        rMTG_stim = mean(data(rMTG,:,:),1);
        rVPF_stim = mean(data(rVPF,:,:),1);
        
        matrix_ROI = vertcat(lACC_stim,lAMY_stim,lDPF_stim,lLOF_stim,lMOF_stim,lMTG_stim,...
            lVPF_stim,...
    ...
    case 'DBSTRD002' 
          ...
          matrix_ROI = vertcat(lACC_stim,lAMY_stim,lDPF_stim,lLOF_stim,...
