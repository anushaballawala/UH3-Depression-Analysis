%%  function that performs normalization and averages across trials 

function [pc_stim_avg_time,pc_poststim1_avg_time,...
    pc_poststim2_avg_time] = perform_single_tr_norm(data,freqs)
...
% 5. Perform average across trials 
...
pc_poststim2_avg_time = mean(pc_poststim2_avg_trials, 2); 
end 