...
function [stim_e1,poststim1_e1,poststim2_e1,...
    ...
    stim_e, poststim1_e, poststim2_e] = compute_single_tr_for_each_contact_config(DBStarget,data,freqs) 
switch DBStarget 
    case 'lSCC' 
    for i = 1:numel(data.output_and_metadata)
       ...
       poststim1_e = horzcat(poststim1_e1, poststim1_e25,...
           poststim1_e36, poststim1_e47, poststim1_e234, poststim1_e567, poststim1_e8); 
       poststim2_e = horzcat(poststim2_e1, poststim2_e25,...
           poststim2_e36, poststim2_e47, poststim2_e234, poststim2_e567, poststim2_e8);
